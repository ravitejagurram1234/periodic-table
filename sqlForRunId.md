...
GROUP BY r.id_run, s.id_suivi, s.id_gabarit, s.id_type_rapport, r.id_statut_generation
HAVING   COUNT(DISTINCT rt.id_tache) > 0          -- at least one TODO task actually runs
